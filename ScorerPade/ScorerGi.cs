...
namespace BarnesGPade {
    internal class ScorerGi {
        static void Main() {

            List<(MultiPrecision<Pow2.N32> x, MultiPrecision<Pow2.N32> y)> expecteds = new();

            using StreamReader sr = new("../../../../results_disused/scorer_gi_n32_log2.csv");
            ...
            using StreamWriter sw_result = new("../../../../results_disused/scorer_gi_e32_pade.csv");
